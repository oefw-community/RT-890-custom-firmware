...
{
	if (DarkMode) {
		COLOR_BACKGROUND = COLOR_RGB( 0, 0, 0); //0
		COLOR_FOREGROUND = COLOR_RGB(20, 59, 29); //42877
		
	} else {
		COLOR_BACKGROUND = COLOR_RGB(20, 59, 29);
		COLOR_FOREGROUND = COLOR_RGB(0, 0, 0);

	}
	COLOR_RED   = COLOR_RGB(28,  9,  4); //57636
	COLOR_GREEN = COLOR_RGB( 9, 52,  4); //20100
	COLOR_BLUE  = COLOR_RGB( 4,  9, 28); //8508
	COLOR_GREY  = COLOR_RGB(16, 32, 16); //33808
